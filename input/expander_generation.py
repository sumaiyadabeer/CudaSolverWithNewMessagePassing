...
#system args: n, type of random_graph, output file path    
if args.type == "margulis":
	G = margulis_gabber_galil_graph(math.sqrt(n)) #graph of size n^2
    	
elif args.type == "paley":
	G = paley_graph(n)	#graph of size n
	
elif args.type == "chordal_cycle":
	G = chordal_cycle_graph(n)	#graph of size n
else: 
	print("Please enter valid expander type")
